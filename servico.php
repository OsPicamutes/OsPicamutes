                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="data/hora" class="control-label origatorio">Data/Hora</label>
                                        <input type="text" class="form-control" id="nome-completo" name="nome-completo" placeholder="Data/Hora">
                                    </div> 
                                    <div class="form-group col-md-4">                                        
                                        <label for="data-nascimento" class="control-label origatorio">Atendente</label>
                                        <select class="form-control">
                                            <option class="">Selecione</option>
                                        </select>                                        
                                    </div>
                                    <div class="form-group col-md-4">                                        
                                        <label for="" class="control-label origatorio">Passageiro</label>
                                        <input type="text" class="form-control" id="" name="" placeholder="Passageiro">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">                                        
                                        <label for="" class="control-label origatorio">Vendedor</label>
                                        <input type="text" class="form-control" id="" name="" placeholder="Vendedor">
                                    </div>
                                    <div class="form-group col-md-4">                                        
                                        <label for="" class="control-label origatorio">Viagem</label>
                                        <input type="text" class="form-control" id="" name="" placeholder="Viagem">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <div class="table-responsive tabela-prog">
                                            <table class="dados-os table table-bordered  table-responsive" style="border-collapse: collapse;" id="tabela">
                                                <thead style="background-color: #bae5ff;">
                                                        <tr>
                                                            <th style="border-right:solid 1px #cecece;"><span class="span-table">Codigo</span></th>
                                                            <th style="border-right: solid 1px #cecece;"><span class="span-table2">Serviços</span></th>
                                                            <th style="border-right: solid 1px #cecece;"><span class="span-table2">Tipo</span></th>
                                                            <th style="border-right: solid 1px #cecece;"><span class="span-table2">QTDA</span></th>
                                                            <th style="border-right: solid 1px #cecece;"><span class="span-table2">Preço</span></th>
                                                            <th style="border-right: solid 1px #cecece;"><span class="span-table2">Total</span></th>
                                                            <th><i class="fa fa-plus icon-table" style="color: #0080CD" id="" accesskey="i" data-toggle="tooltip" data-placement="top" title="Adicionar Alt+i"></i></th>
                                                        </tr>
                                                </thead>
                                                <tbody id="tabela-contatos" style="background-color: #e0e0e0;">
                                                        <td style="border:solid 1px #cecece">
                                                            <input type="text" class="form-control" name="" placeholder="Codigo" id="">
                                                        </td>
                                                        <td style="border:solid 1px #cecece;">
                                                            <input type="text" class="form-control" name="" placeholder="Serviços" id="">
                                                        </td>
                                                        <td style="border:solid 1px #cecece;">
                                                            <input type="text" class="form-control" name="" placeholder="Tipo" id="">
                                                        </td>
                                                        <td style="border:solid 1px #cecece;">
                                                            <input type="text" class="form-control" name="" placeholder="QTDA" id="">
                                                        </td>
                                                        <td style="border:solid 1px #cecece;">
                                                            <input type="text" class="form-control" name="" placeholder="Preço" id="">
                                                        </td>
                                                        <td style="border:solid 1px #cecece;">
                                                            <input type="text" class="form-control" name="" placeholder="Total" id="">
                                                        </td>
                                                        <td style="border: solid 1px #cecece;">
                                        ...
                                        <div class="col-md-4">
                                            <table class="dados-os table table-bordered table-hover" style="font-size: larger;margin-top:-20px;margin-left: 15px;;">
                                                <tbody>
                                                    <tr>
                                                        <th>SubTotal </th>
                                                    ...
                                                    <tr>
                                                        <th>Desconto (%)</th>
                                                        <th class="font_secundaria">150 %</th>
                                                    </tr>
                                                    <tr>
                                                        <th>Desconto R$</th>
                                                        <th class="font_secundaria">R$ 150,00</th>
