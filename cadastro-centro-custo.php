                            ...
                            <form>
                                <div class="table-responsive tabela-prog">
                                    <table id="tabela-pag" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="">Descrição do centro de custo</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> Cadastro do Centro de Custo</h4>
                </div>
                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="descricao-centro-custo" class="control-label origatorio">Descrição do centro de custo</label>
                                        <input type="text" class="form-control" id="descricao-centro-custo" name="descricao-centro-custo" placeholder="Descrição do centro de custo">
                                    </div>
                                </div>
                            </form>
                        </div>
