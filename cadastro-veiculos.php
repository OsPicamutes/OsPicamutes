                                    ...
                                    <table id="tabela-pag" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="">NÚMERO DE POLTRONAS</th>
                                                <th class="">VENCIMENTO IPVA</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> Cadastro de Veículos</h4>
                </div>
                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="descriçao-veiculo" class="control-label origatorio">Descrição do veículo</label>
                                        <input type="text" class="form-control" id="descriçao-veiculo" name="descriçao-veiculo" placeholder="Descrição Veiculo">
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="placa" class="control-label origatorio">Placa</label>
                                        <input type="text" class="form-control mask-placa" style="text-transform: uppercase;" id="placa" name="placa" placeholder="Placa">
                                    </div>  
                                    <div class="form-group col-md-4">
                                        <label for="ano-modelo" class="control-label origatorio">Ano/Modelo</label>
                                        <input type="text" class="form-control mask-ano" id="ano-modelo" name="ano-modelo" placeholder="Ano/Modelo">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="numero-poltronas" class="control-label origatorio">Número de poltronas</label>
                                        <input type="text" class="form-control" id="numero-poltronas" name="numero-poltronas" placeholder="Número Poltronas">
                                    </div>                                   
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">                                        
                                        <label for="m3" class="control-label origatorio">Capacidade máxima M³</label>
                                        <input type="text" class="form-control" id="m3" name="m3" placeholder="Capacidade máxima M³">
                                    </div>
                                    <div class="form-group col-md-4">                                        
                                        <label for="kg" class="control-label origatorio">Capacidade máxima KG</label>
                                        <input type="text" class="form-control" id="kg" name="kg" placeholder="Capacidade máxima KG">
                                    </div>
                                    <div class="form-group col-md-4">                                        
                                        <label for="vencimento" class="control-label origatorio">Vencimento IPVA</label>
                                        <input type="text" class="form-control data-picker mask-date" id="vencimento" name="vencimento" placeholder="Vencimento IPVA" maxlength="10">
                                    </div>
                                </div>
                            </form>
                        </div>
