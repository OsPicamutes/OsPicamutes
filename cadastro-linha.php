        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> Cadastro de Linha</h4>
                </div>
                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="descricao-linha" class="control-label origatorio">Descrição da linha</label>
                                        <input type="text" class="form-control" id="descricao-linha" name="descricao-linha" placeholder="Descrição da linha">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label for="origem" class="control-label origatorio">Origem</label>
                                        <input type="text" class="form-control" id="origem" name="origem" placeholder="Origem">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="destino" class="control-label origatorio">Destino</label>
                                        <input type="text" class="form-control" id="destino" name="destino" placeholder="Destino">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="valor-passagem" class="control-label origatorio">Valor</label>
                                        <input type="text" class="form-control mask-money" id="valor-passagem" name="valor-passagem" placeholder="Valor">
                                    </div>
                                    <div class="form-group col-md-3 clockpicker">
                                        <label for="horario-saida" class="control-label origatorio">Horário de saída</label>
                                        <input type="text" class="form-control mask-horas" id="horario-saida" name="horario-saida" value="" placeholder="HH:MM">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="table-responsive" style="margin-top: 5px;">
                                            <table class="table table-bordered table-responsive tabela-modal" id="tabela">
                                                <thead style="background-color: #bae5ff;">
                                                    <tr>
                                                        <th style="border-right:solid 1px #bae5ff;" class="col-md-4"><span class="span-table">Serviços</span></th>
                                                        <th style="border-right: solid 1px #bae5ff" class="col-md-4"><span class="span-table2">Tipo : </span></th>
                                                        <th style="border-right: solid 1px #bae5ff" class="col-md-4"><span class="span-table2">Valor</span></th>
                                                        <th  style="width: 30px"><i class="fa fa-plus icon-table" style="color: #0080CD" id="add2" accesskey="i" data-toggle="tooltip" data-placement="top" title="Adicionar Alt+i"></i></th>
                                                    </tr>
                                                </thead>
