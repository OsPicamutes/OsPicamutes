                            ...
                            <form enctype="multipart/form-data">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item" id="ativar_tab_representante">
                                        <a class="nav-link" href="#representante" role="navigation" data-toggle="tab" aria-expanded="false">Dependentes</a>
                                    </li>
                                                ...
                                                <table class="dados-os table table-striped table-bordered table-hover table-responsive">
                                                    <thead style="background-color: #bae5ff;">
                                                        <tr>
                                                            ...
                                                            <th style="width: 30px"><i class="fa fa-plus icon-table" style="color: #0080CD" id="add" accesskey="i" data-toggle="tooltip" data-placement="top" title="Adicionar Alt+i"></i></th>
                                                        </tr>
                                                    </thead>
                                            ...
                                            <div class="table-responsive tabela-prog">
                                                <table class="dados-os table table-striped table-bordered table-hover table-responsive">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="9" class="table-programa-col-vencidas" style="text-align: center;background-color: #d0d0d0">
                                                                <span style="font-size: 20px;color: red;">Passagens sair :</span>
                                                            </th>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div class="table-responsive tabela-prog">
                                                <table class="dados-os table table-striped table-bordered table-hover table-responsive">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="9" class="table-programa-col-vencidas" style="text-align: center;background-color: #d0d0d0">
                                                                <span style="font-size: 20px;color: red;">Encomendas sair :</span>
                                                            </th>
                                                        </tr>
                                                        <tr>
