                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-5">
                                        <label for="" class="control-label origatorio">Conta Analítica</label>
                                        <select class="form-control">
                                            <option>Selecione</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label for="" class="control-label origatorio">Débito/Crédito</label>
                                        <select class="form-control">
                                            <option>Selecione</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <label for="" class="control-label origatorio">Valor R$</label>
                                        <input type="text" class="form-control" id="" name="" placeholder="Valor R$">
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label for="" class="control-label origatorio">Gerar Recibo ? </label>
                                        <select class="form-control">
                                            <option>Selecione</option>
                                            <option>Sim</option>
                                            <option>Não</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <label for="" class="control-label origatorio">Historico</label>
                                        <textarea rows="4" cols="25" class="form-control"></textarea>
                                    </div>                                    
                                </div>
                            </form>
                        </div>
