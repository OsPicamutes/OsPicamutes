        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> Cadastro de Motorista</h4>
                </div>
                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="nome-completo" class="control-label origatorio">Nome Completo</label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">                                        
                                        <label for="vencimento-cnh" class="control-label origatorio">Vencimento CNH</label>
                                        <input type="text" class="form-control data-picker mask-date" id="vencimento-cnh" name="vencimento-cnh" placeholder="Vencimento CNH">        
                                    </div>
                                    <div class="form-group col-md-4">                                        
