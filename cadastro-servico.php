                            ...
                            <form>
                                <div class="table-responsive tabela-prog">
                                    <table id="tabela-pag" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="">DESCRIÇÃO DO SERVIÇO</th>
                                                <th class="">TIPO :</th>
                                                <th class="">PREÇO R$</th>
                                                <th class=""></th>
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>SACO DE MILHO PARA GALINHA</td>
                                                <td>KG</td>
                                                <td>R$ 200,500</td>
                            ...
                            <form enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="descriçao-serviço" class="control-label origatorio">Descrição do serviço</label>
                                        <input type="text" class="form-control" id="descriçao-serviço" name="descriçao-serviço" placeholder="Descrição do Serviço">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="tipo-serviço" class="control-label origatorio">Tipo : </label>
                                        <select class="form-control" id="tipo-serviço">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="preço-serviço" class="control-label origatorio">Preço R$</label>
                                        <input type="text" class="form-control mask-money" id="preço-serviço" name="preço-serviço" placeholder="Preço R$">
                                    </div>
                                </div>
                            </form>
                        </div>
